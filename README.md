...
compiler attaches those identifiers to the domain files by B3's own name for the attribute, which
reaches about two thirds of them, and reports the rest per figure. "Is this figure complete?" now
has a published answer rather than a reading of the manual, and the gap is a list rather than a
suspicion.
